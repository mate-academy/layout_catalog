Yatsyna# Frontend practice with catalog page
Replace `<your_account>` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://Yatsyna.github.io/layout_catalog/)
- [TEST REPORT LINK](https://Yatsyna.github.io/layout_catalog/report/html_report/)
