...
Create HTML page with catalog. Develop semantic page structure as shown on [the mockup](npm start).
...
- [DEMO LINK](https://OlenaZiniak.github.io/layout_catalog/)
- [TEST REPORT LINK](https://OlenaZiniak.github.io/layout_catalog/report/html_report/)
