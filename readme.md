...
- [DEMO LINK](https://RuslanaTomnyuk.github.io/layout_catalog/)
- [TEST REPORT LINK](https://RuslanaTomnyuk.github.io/layout_catalog/report/html_report/)
...
- add class `is-active` to the first listylesnk (`Apple`) in navigation
