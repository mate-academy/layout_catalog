...
- [DEMO LINK](https://OksanaGrygorchuk.github.io/layout_catalog/)
- [TEST REPORT LINK](https://OksanaGrygorchuk.github.io/layout_catalog/report/html_report/)
...
- add class `nav__link--active` to the first link (`Apple`) in navigation
