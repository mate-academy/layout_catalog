...
- [DEMO LINK](https://viktorlyt.github.io/layout_catalog/)
- [TEST REPORT LINK](https://viktorlyt.github.io/layout_catalog/report/html_report/)
...
- cards container__item should have fixed paddings (see 1024px example), bottom the same as top
