...
- change the card name text color to `#34568b` when the card is hovered (`.card:hover .card__title`)
...
- [DEMO LINK](https://<kgGugala>.github.io/layout_catalog/)
- [TEST REPORT LINK](https://kgGugala.github.io/layout_catalog/report/html_report/)
