...
- [DEMO LINK](https://yuliia-dronova.github.io/layout_catalog/)
- [TEST REPORT LINK](https://yuliia-dronova.github.io/layout_catalog/report/html_report/)
...
- add `="nav-hover"` (not just `hover`) to the 4th nav link for testing (`Ноутбуки и компьютеры`)
- add `` to the first card
- add `="card-hover"` (not just `hover`) to the link `Купить` inside the first card
---
