...
- add class `nav-link--is-active` to the first link (`Apple`) in navigation
- use `<main>` for cards header__container
...
- cards header__container have fixed paddings (`50px` vertically and `40px` horyzontally)
...
- [DEMO LINK](https://dionechik.github.io/layout_catalog/)
- [TEST REPORT LINK](https://dionechik.github.io/layout_catalog/report/html_report/)
