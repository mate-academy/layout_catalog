...
- [LINK](https://dsrtf0x-git.github.io/layout_catalog/)
- [REPORT LINK](https://dsrtf0x-git.github.io/layout_catalog//report/html_report/)
На кнопках стоит задержка 0.2s, потому что без задержки почему-то не проходил тест при :hover'e кнопки(не видело изменений бэкгрануда).
