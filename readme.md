...
❗️ Replace `<VladChudin>` with your Github username and copy the links to `Pull Request` description:
- [DEMO LINK](https://<VladChudin>.github.io/layout_catalog/)
- [TEST REPORT LINK](https://<VladChudin>.github.io/layout_catalog/report/html_report/)
